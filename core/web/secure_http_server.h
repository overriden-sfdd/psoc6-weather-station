...
#define HTTPS_SERVER_NAME                        "mysecurehttpserver" /* <NEW> */
...
#define HTTPS_REFRESH_INTERVAL                   (2)                               /* <NEW> */
...
#define PORT_SIZE_LEN                            (10)                             /* <NEW> */
#define MAX_HTTP_RESPONSE_LENGTH                 (sizeof(HTTPS_STARTUP_WEBPAGE) + sizeof(HTTPS_SERVER_NAME) + PORT_SIZE_LEN + sizeof(MAX_LED_STATUS_LENGTH) + 50 + 1) /* <NEW> */
