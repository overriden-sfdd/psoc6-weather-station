...
void mqtt_client_task(void *pvParameters)
{
	...
	print_heap_usage("mqtt_client_task: publisher task created");
...
void mqtt_event_callback(cy_mqtt_t mqtt_handle, cy_mqtt_event_t event, void *user_data)
{
	...
	case CY_MQTT_EVENT_TYPE_SUBSCRIPTION_MESSAGE_RECEIVE:
	{
		...
		printf("Subscription message received even though this should've never happened\n");
		break;
	}
	default :
	{
...
static void cleanup(void)
{
	...
	// TODO: do we really want to de-init the Wi-Fi? It's used in the other task
